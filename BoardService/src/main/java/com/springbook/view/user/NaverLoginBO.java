...
public class NaverLoginBO {
	...
	private final static String CLIENT_ID = "uBQEsvzDGTRNN6lYngNP";
    private final static String CLIENT_SECRET = "yXRhHvwHA4";
    private final static String REDIRECT_URI = "http://localhost:8080/BoardWeb/getBoardList.do";
