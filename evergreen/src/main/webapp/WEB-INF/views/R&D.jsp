                ...
                <div class="container">
                    ...
                    <div class="collapse navbar-collapse" id="navbarResponsive">
                        <ul class="navbar-nav ml-auto hornbill-nav">
                            ...
                            <li class="nav-item">
                                <a class="active nav-link" href="research_development.do"><spring:message code="message.main.header.menu05"/></a>
                            </li>
                            <li class="nav-item">
                ...
                <div class="container">
                    <section class="row">
                        <div class="col-rnd-2 col-md-6 fadeInUp applications-div-2">
                            <div class="icon">
                                <div>
                                	<spring:message code="message.rnd.section.global01"/>
                                </div>
                                <br>
                                <div>
                                	<span style="font-weight: bold;"><spring:message code="message.rnd.section.global02"/></span><spring:message code="message.rnd.section.global03"/>
                                </div>
                                <br>
                                <div>
                                	<spring:message code="message.rnd.section.global04"/>
                                </div>
                                <br>
                                <div>
                                	<spring:message code="message.rnd.section.global05"/>
                                </div>
                            </div>
                        </div>
