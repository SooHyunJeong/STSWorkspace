        ...
        <main class="main-section">
                    ...
                    <div class="row">
                        <div class="fadeIn banner-section-div">
                            ...
                            <div class="p-top-100 banner-section-div-1">
                            	<div>
	                            	<spring:message code="message.procam.section.banner01"/><span class="procam-explanation"><spring:message code="message.procam.section.banner02"/></span>.<br>
	                            	<spring:message code="message.procam.section.banner03"/><span class="procam-explanation"><spring:message code="message.procam.section.banner04"/></span><spring:message code="message.procam.section.banner05"/><span class="procam-explanation"><spring:message code="message.procam.section.banner06"/></span><spring:message code="message.procam.section.banner07"/>
	                            	<spring:message code="message.procam.section.banner08"/><span class="procam-explanation"><spring:message code="message.procam.section.banner09"/></span><spring:message code="message.procam.section.banner10"/><span class="procam-explanation"><spring:message code="message.procam.section.banner11"/></span><spring:message code="message.procam.section.banner12"/><span class="procam-explanation"><spring:message code="message.procam.section.banner13"/></span>
                            	</div>
                            </div>
                ...
                <div class="container">
                    ...
                    <section class="row">
                        <div class="fadeIn">
                        	...
                        	<p class="hard-coating-solution-p"><spring:message code="message.procam.section.hardcoating01"/></p>
                            <div>
            ...
            <div id="classification" class="p-top-50 p-bot-50">
                <div class="container">
                    ...
                    <section class="row">
                        ...
                        <hr>
                        <div class="col-c-1 col-md-6 fadeIn">
                            <spring:message code="message.procam.section.classification03"/>
                        </div>
                        <hr>
                        <div class="col-c-1 col-md-6 fadeIn">
                            <spring:message code="message.procam.section.classification04"/>
                        </div>
                        <hr>
                        <div class="col-c-1 col-md-6 fadeIn">
                            <spring:message code="message.procam.section.classification05"/>
                        </div>
                    </section>
            ...
            <div id="coating-features" class="p-top-50 p-bot-50">
                <div class="container">
                    ...
                    <section class="row">
                       	<div class="icon">
                       		<h3 class="coating-features-header myraid-regular"><spring:message code="message.procam.section.features01"/></h3>
                       	</div>
